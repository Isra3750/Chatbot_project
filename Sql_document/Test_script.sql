...
docker run --name DB23 -p 1521:1521 -e ORACLE_PWD=Pass1234 -e ORACLE_CHARACTERSET=AL32UTF8 
-e ENABLE_ARCHIVELOG=true -e ENABLE_FORCE_LOGGING=true  -v C:/Users/USER/Desktop/Chatbot_project/onnx_model:/u01/models 
